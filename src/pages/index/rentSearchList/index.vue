<template>
    <div class="rentSearchList">
        ...
        <div class="filterArea">
            ...
            <ul v-for="type in subTypes" :key="type.type" class="subContent" :class="{active:currSubType==type.type}">
                <li v-for="(item,idx) in type.items" :key="idx" @click="selectType({type:type.type,value:item.label})">
                    <p :class="{active:!selectedTypes[type.type]&&item.label=='不限'}" v-if="idx==0">{{item.label}}</p>
        ...
        <div class="resultArea">
            <template v-if="searchList.length">
                <div v-for="(item,idx) in searchList" :key="item.address+idx" class="listItem" @click="linkToDetail(item)">
                    <div class="thumbImg">
    ...
    data() {
        return {
            ...
            subTypes: [
                ...
                {
                    type: 'rentType',
                    items: [{ label: '不限', value: '' }, { label: '整租', value: '1' }, { label: '合租', value: '2' }]
                }
            ]
        };
    },
